...
class Application(tk.Frame):
	...
	def make_backup(self):
		...
		with open(os.path.join(sys._MEIPASS,"backups", datetime.datetime.now().strftime("%s") + ".json"), "x") as backup_file:
	...
	def get_advancement_file(self):
		...
		return open(os.path.join(sys._MEIPASS,advancement_file_path),"r").read()
